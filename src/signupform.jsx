...
const RegistrationForm = () => {
  ...
  const validationSchema = Yup.object().shape({
    nameTitleTha: Yup.string().required("Required"),
    lastnameTha: Yup.string().required("Required"),
    nameTitleEng: Yup.string().required("Required"),
    firstnameEng: Yup.string()
      .required("Required")
      .matches(/^[a-zA-Z\s]+$/, "Must be in English only"),
    lastnameEng: Yup.string().required("Required"),
    ...
    <section className="container mt-4">
      <div className="mb-4">
        <div className="card border-0 shadow p-4">
          <h3 className="fw-bolder my-4 text-center">Register Form</h3>
          <Formik
                  ...
                  <div className="row">
                    <div className="col-lg-2 mb-3">
                      ...
                      <Field
                        ...
                        className={`form-select ${
                          errors.nameTitleTha && touched.nameTitleTha
                            ? "is-invalid"
                            : ""
                        }`}
                        name="nameTitleTha"
                    ...
                    <div className="col-lg-5 mb-3">
                      ...
                      <Field
                        ...
                        className={`form-control ${
                          errors.firstnameTha && touched.firstnameTha
                            ? "is-invalid"
                            : ""
                        }`}
                        name="firstnameTha"
                    ...
                    <div className="col-lg-5 mb-3">
                      ...
                      <Field
                        type="text"
                        className={`form-control ${
                          errors.lastnameTha && touched.lastnameTha
                            ? "is-invalid"
                            : ""
                        }`}
                        name="lastnameTha"
                  ...
                  <div className="row">
                    <div className="col-lg-2 mb-3">
                      ...
                      <Field
                        as="select"
                        className={`form-select ${
                          errors.nameTitleEng && touched.nameTitleEng
                            ? "is-invalid"
                            : ""
                        }`}
                        name="nameTitleEng"
                  ...
                  <div className="form-check">
                    <Field
                      ...
                      className={`form-check-input ${
                        errors.accept && touched.accept ? "is-invalid" : ""
                      }`}
                      name="accept"
                      id="accept"
                    />
